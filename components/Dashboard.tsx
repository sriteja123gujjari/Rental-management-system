          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid gap-3">
                      {monthlyData.transactions.map((t: any, idx) => (
                        <div key={idx} className="bg-white/5 backdrop-blur-md rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between border border-white/5 gap-3 hover:bg-white/10 transition-colors">
            ...
            <section className="bg-white rounded-[2.5rem] shadow-2xl shadow-indigo-100/60 p-6 sm:p-8 border border-slate-100 relative overflow-hidden group hover:shadow-indigo-200/50 transition-all duration-500"> 
              ...
              <div className="flex flex-col gap-6 relative z-10"> 
                ...
                {/* SUBMIT BUTTON - MATCHED BLACK STYLE */}
                <button 
                  onClick={addExpense} 
